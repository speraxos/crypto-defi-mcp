            ...
            <div className="p-4 rounded-xl bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
              ...
              <div className="flex gap-2">
                ...
                <Button 
                  ...
                  size="sm" 
                  className="flex-1"
                  onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Check out the ${template.name} MCP template on Sperax! ${template.icon}\n\n${template.description}\n\nmcp.sperax.io/templates/${template.id}`)}`, "_blank")}
                >
                  Tweet
                </Button>
              </div>
